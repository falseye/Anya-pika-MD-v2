...
global.simpleBotname = "Aesthetic Ikka" //⚠️ Only use normal and one work name here or you'll get errors ⚠️//

//------------❤️ 𝗕𝗼𝘁 𝗱𝗲𝘁𝗮𝗶𝗹𝘀 ❤️-----------\\

global.botname = "Aesthetic Ikka" 

global.websitex = "https://github.com/falseye" // Website to be displayed //

global.botscript = 'https://github.com/falseye/Anya-pika-MD-v2' // Script link //

global.packname = "Aesthetic Ikka " // sticker watermark packname //

global.author = "@𝘧𝘢𝘭𝘴𝘦_𝘦𝘺𝘦" // sticker watermark author //

actiontitle = '࿙⚜ Aesthetic Ikka⚜࿚' // text who displays on the top of welcome and left message //

global.headerText = "Ikka by Eslem" // text for header of menu //        

     

             //-------------👑Owner & vcard 👑----------\\             

             global.ownernumber = ['919539901834']   // Owner number //

             global.vcardowner = ['919539901834']   // vcard owner number //

             global.ownername = "@𝘧𝘢𝘭𝘴𝘦_𝘦𝘺𝘦"   // Owner name //

             global.ytname = "IG: @false_eye"   // IG username name //

             global.socialm = "𝗚𝗶𝘁𝗵𝘂𝗯 : falseye"   // Github or insta name //

             global.location = "India, Kerala, Alappuzha"   // Location //

             global.owner = ['919539901834','919745043214']

             global.ownertag = '919539901834'  // Tag number //

             global.linkz = "https://wa.me/+919539901834"  // Theme url which will be displayed on whatsapp //

             global.premium = ['919539901834']  // premium numbers //             

             global.waterMark = "Aesthetic Ikka" // Your own watermark //

global.prefa = ['','-']

//--------Random bot name for Info section--------\\

name16 = "Aesthetic Ikka "

name17 = "Aesthetic Ikka"

name18 = "Aesthetic Ikka"

//--------Random footer message-----------\\

footer1 = `Aesthetic Ikka`

footer2 = `Aesthetic Ikka`
...
global.Menudoccap1 = 'Aesthetic Ikka'

global.Menudoccap2 = 'Aesthetic Ikka'

global.Menudoccap3 = 'Aesthetic Ikka'

global.Menudoccap4 = "Aesthetic Ikka "

global.Menudoccap5 = 'Aesthetic Ikka'

//--------Random Tag msg--------\\

tag1 = '𝘏𝘦𝘺 𝘦𝘷𝘦𝘳𝘺𝘣𝘰𝘥𝘺😚, 𝘊𝘰𝘮𝘦 𝘰𝘯𝘭𝘪𝘯𝘦' 

tag2 = '𝘖𝘺𝘦 𝘦𝘷𝘦𝘳𝘺𝘰𝘯𝘦!! 𝘞𝘩𝘦𝘳𝘦 𝘢𝘳𝘦 𝘺𝘰𝘶 𝘢𝘭𝘭?😐' 

tag3 = 'Online Come yaar!😑' 
...
tag8 = '𝘏𝘦𝘺 𝘸𝘩𝘦𝘳𝘦 𝘺𝘰𝘶 𝘢𝘭𝘭?..' 

tag9 = '🙂' 

tag10 = '𝘈𝘺𝘰𝘰 Eslem 𝘪𝘴 𝘉𝘦𝘴𝘵!!😚' 
...
global.mess = {
    ...
    nsfw: 'The nsfw feature has not been activated, Bc padhai likhai karo 𝗜𝗔𝗦 - 𝗬𝗔𝗦',
